...
namespace Sakadda\Cli\Services;

use Sakadda\Cli\Services\StarterKit;
// use Sakadda\Cli\Traits\HasTaggableCacheTrait;
...
class BoilerplateGenerator
{
    ...
    {
        return config('boilerplate-generator.pest_enabled', true);
    }
    ...
    public function getLoadedPackages(bool $with_details = false): Collection
    {
        ...
        print_r($st);
        return $st->getPackages()->map(function ($package, $vendor_name) use ($with_details) {
