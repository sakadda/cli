...
class LegacyInstaller
{
    ...
    protected function getLatestVersion()
    {
        ...
        $this->version = (new Client)
            ->get('https://sakadda.com/v2/check')
            ->getBody();
    ...
    {
        $this->zipFilename = getcwd().'/sakadda_'.md5(time().uniqid());
    ...
    protected function applyPermissions()
    {
        ...
        foreach (['local', 'site', 'sakadda', 'assets'] as $folder) {
    ...
    protected function getZipFromServer()
    {
        ...
        $response = $client->get("https://outpost.sakadda.com/v2/get/{$this->version}");
    ...
    protected function cleanUp()
    {
        ...
        rename($this->command->absolutePath.'_tmp/sakadda', $this->command->absolutePath);
