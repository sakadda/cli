...
class NewCommandIntegrationTest extends TestCase
{
    ...
    /** @test */
    public function it_can_scaffold_a_new_sakadda_app_with_a_starter_kit()
    {
        $this->assertAppNotExists();

        $statusCode = $this->scaffoldNewApp(['starter-kit' => 'sakadda/starter-kit-cool-writings']);
    ...
    public function it_can_scaffold_with_starter_kit_config()
    {
        ...
        $statusCode = $this->scaffoldNewApp(['starter-kit' => 'sakadda/starter-kit-cool-writings', '--with-config' => true]);
    ...
    /** @test */
    public function it_can_scaffold_a_legacy_v2_sakadda_app()
    {
        $this->assertAppNotExists();
        ...
        $this->assertFileExists($this->appPath('sakadda'));
    }
    ...
    {
        $this->assertRuntimeException(function () {
            $this->scaffoldNewApp(['starter-kit' => 'sakadda/starter-kit-cool-writings', '--v2' => true]);
        });
    ...
    {
        $this->assertRuntimeException(function () {
            $this->scaffoldNewApp(['starter-kit' => 'sakadda/not-an-actual-starter-kit']);
        });
